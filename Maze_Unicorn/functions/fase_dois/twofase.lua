function labirinto_fase_two_draw()
...
-- background
	...
	love.graphics.setColor(247, 212, 14)
	love.graphics.rectangle("fill", 75,  525, 805, 80 )
	...
	love.graphics.setColor(247, 212, 14)
	love.graphics.rectangle("fill", 800,  250, 80, 320 )           
	...
	love.graphics.setColor(247, 212, 14)
	love.graphics.rectangle("fill", 150, 420, 329.5, 60)
	...
	love.graphics.setColor(247, 212, 14)
	love.graphics.rectangle("fill", 220,  125, 1000, 80 )
	...
	love.graphics.setColor(247, 212, 14)
	love.graphics.rectangle("fill", 150,  125, 80, 353)
	...
	love.graphics.setColor(247, 212, 14)
	love.graphics.rectangle("fill", 400,  250, 80, 200 )
	...
	love.graphics.setColor(247, 212, 14)
	love.graphics.rectangle("fill", 529.5,  250, 80, 200 )
